...
This repository contains a static website for presenting projects in a vertically ordered year-based timeline.

## Core requirements

- The visual direction follows a dark green and black interface with a terminal-inspired mood.
- The homepage opens directly into summary cards and the project timeline.
